...
export class FeedRepo {
  ...
  static async getSavedItems(params: { userId: string; cursor: string | null; limit: number }) {
  ...
  static async getPersonalizedFeed(params: { userId: string; cursor: string | null; limit: number }) {
